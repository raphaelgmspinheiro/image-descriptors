...
from gera_descritor_entropia_diferencial_curvatura_multi_py3 import entropia_diferencial_curvatura
...
if __name__ == '__main__':
    ...
    im_database_dir='C:/Users/Raphael/Desktop/mec/kimia99/'
    result_file='C:/Users/Raphael/Desktop/mec/Resultados/'
    cost_function=db
    
    #search_range=np.array([[0.4,100],[0.4,100],[0.4,100],[0.4,100],[0.4,100]]) #Search space
    search_range = np.array([[25, 200], [25, 200], [25, 200], [25, 200], [25, 200]])
    ...
    descriptor_function=partial(entropia_diferencial_curvatura,database_dir=im_database_dir,database_classes=np.load(im_database_dir+'classes.txt'))
