...
if __name__ == '__main__':
    ...
    result_dir = 'C:/Users/rapha/Desktop/TextureDescriptors/MED115/to_describe/describe/'
    #CUIDADO COM O OS.LISTDIR
    file_names_list = os.listdir(params_dir)
    file_names_list = file_names_list[1::]

    descriptor_function = partial(entropia_diferencial_curvatura, database_dir=im_database_dir,
